...
interface CartLineRemoveButtonProps {
  lineIds: string[];
  disabled: boolean;
}

interface CartLineUpdateButtonProps {
 ...
 */
export function CartLineItem({layout, line}: CartLineItemProps) {
 ...
 */
function CartLineQuantity({line}: CartLineQuantityProps) {
